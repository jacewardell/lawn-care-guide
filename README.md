...
Every claim comes from one of six Utah State University Extension documents. Five are peer-reviewed
fact sheets; the sixth is a web checklist and is outranked wherever it conflicts.
...
Three visual states, decided before any content was written:
...
186 markers on the page: 168 sourced, 7 derived, 11 conflict.
...
4. No bag label is treated as guidance. Two commercial lawn-care articles were in the source folder
   and are deliberately excluded, cited nowhere.
...
The Salt Lake Valley: USU's northern Utah calendar region, in-ground irrigation zones on a
weather-based controller, alkaline soil around pH 7.5, and a lawn that gets moderate family use
(the 3-feedings-a-year row).
